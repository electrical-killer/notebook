...
export default function IdealImage(props: Props): JSX.Element {
  ...
  if (typeof img === 'string' || (img && typeof img === 'object' && 'default' in img && img.default)) {
    return (
  ...
  if (!img || !img.src || !img.preSrc) {
    return null; // 或者返回一个占位符图像
  }

  const { height = 100, width = 100, src, images = [] } = img.src;
