...
import { type Project, type Tag, TagList, type TagType, Tags } from '@site/src/data/projects/projects'
import Tooltip from '@site/src/components/Tooltip'
import { MagicCard } from '@site/components/ui/magic-card'
import FavoriteIcon from '@site/src/components/svgIcons/FavoriteIcon'
import { cn } from '@site/src/lib/utils'
import { sortBy } from '@site/src/lib/jsUtils'
      ...
      <div className="card__body">
        <div className={cn(styles.showcaseCardHeader)}>
          ...
          {project.source && (
            ...
            >
              <Translate id="showcase.card.sourceLink">Sound Code</Translate>
            </Link>
          )}
        </div>
