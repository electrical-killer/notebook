    ...
    project: [
        "project/project",
        {
            ...
            items: [
                {
                    type: "autogenerated",
                    dirName: "project/50projects50days",
                },
            ],
        },
        {
            ...
            items: [
                ...
                "project/Docusaurus/Docusaurus",
                "project/Docusaurus/1731504771",
                "project/Docusaurus/1731504795",
                {
                    label: "部署",
                    type: "category",
                    link: { type: "generated-index" },
                    items: [
                        {
                            type: "autogenerated",
                            dirName: "project/Docusaurus/deploy",
                        },
                    ],
                },
                {
                    ...
                    items: [
                        {
                            type: "autogenerated",
                            dirName: "project/Docusaurus/custom",
                        },
                    ],
                },
            ],
